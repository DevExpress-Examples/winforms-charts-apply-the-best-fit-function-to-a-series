...
Namespace LineOfBestFit
    ...
    Public Partial Class Form1
        ...
        Private Shared Function GetPointForLinearRegression(ByVal series As Series, ByVal argument As Object, ByVal functionArguments As String(), ByVal values As DataSourceValues(), ByVal colors As Object()) As ISeriesPoint()
        ...
        Private Sub button1_Click(ByVal sender As Object, ByVal e As EventArgs)
            ...
            chartControl1.Series(1).SummaryFunction = "BESTFIT()"
